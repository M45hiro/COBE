...
using SAM. It forms an integral part of the yolov8.ultralytics framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model, verbose=True):
        ...
        parameters for image normalization and other yolov8.ultralytics compatibility settings.
        ...
        # yolov8.ultralytics compatibility settings
        self.model.pt = False
