...
class FourLLIE_my(nn.Module):
    ...
    def forward(self, x):
        ...
        # enhence Y
        image_fft = torch.fft.fft2(Y, norm='backward')
        ...
        # enhence Cr
        enhenced_Cr = Cr
        enhenced_all = ycbcr_to_rgb(Y, enhenced_Cb, enhenced_Cr)
        ...
        return out_noise, mag_image, x_center, mask, enhenced_Cb, enhenced_Cr
