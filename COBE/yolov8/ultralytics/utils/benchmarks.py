...
Usage:
    from yolov8.ultralytics.utils.benchmarks import ProfileModels, benchmark
...
from yolov8.ultralytics.cfg import TASK2DATA, TASK2METRIC
from yolov8.ultralytics.engine.exporter import export_formats
from yolov8.ultralytics.utils import ASSETS, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from yolov8.ultralytics.utils.checks import check_requirements, check_yolo
from yolov8.ultralytics.utils.files import file_size
...
def benchmark(
    ...
    Example:
        ```python
        from yolov8.ultralytics.utils.benchmarks import benchmark
...
class ProfileModels:
    ...
    Example:
        ```python
        from yolov8.ultralytics.utils.benchmarks import ProfileModels
